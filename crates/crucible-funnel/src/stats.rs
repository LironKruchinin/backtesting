//! Overfitting-aware statistics — **M3 spec, not yet implemented.**
//!
...
//!   trials (from `registry`, per hypothesis family — never trust a
//!   hand-entered trial count), skewness, and kurtosis of returns. A
//!   headline Sharpe without its trial count is not reported anywhere.
